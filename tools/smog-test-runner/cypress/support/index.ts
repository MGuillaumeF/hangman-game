...
declare global {
  namespace Cypress {
    interface Chainable {
       ...
       */
      addPage( id: string, ...elements: any[]):Chainable<Element>,
     /**
      ...
      */
       ...
       * @returns The added page
       */
      addPresentation(title: string, project: string, version: string, author: string): Cypress.Chainable<Document>
    }
  }
}
 ...
 * @returns The added page
 */
Cypress.Commands.add("addPresentation", (
  title: string,
