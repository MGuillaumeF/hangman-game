...
const HTTP_TEST_PORT = process.env.HTTP_TEST_PORT || (HTTP_TEST_PROTOCOL === "https" ? "443" : "80");
const HTTP_TEST_DOMAIN_NAME = process.env.HTTP_TEST_DOMAIN_NAME || "localhost";
const HTTP_TEST_PREFIX_LOCATION = process.env.HTTP_TEST_PREFIX_LOCATION || "/";
