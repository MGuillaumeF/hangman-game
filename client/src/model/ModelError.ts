...
export class ModelError {
  ...
  private _code: e_attribute_error;
   ...
   */
  public set code(value: e_attribute_error) {
    this._code = value;
  }
  /**
   * @brief Get the code of object
   *
   * @return e_attribute_error the code of object
   */
  public get code(): e_attribute_error {
    return this._code;
  }
  /**
   ...
   *
   * @return string the attributeName of object
   */
   ...
   *
   * @return string the message of object
   */
